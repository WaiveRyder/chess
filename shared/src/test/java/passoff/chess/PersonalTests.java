...
public class PersonalTests {
    ...
    @Test
    @DisplayName("RookMove Possible")
    public void rookMovePossible(){
        ChessBoard board = new ChessBoard();

        ChessPosition position1 = new ChessPosition(2, 2);
        board.addPiece(position1, new ChessPiece(ChessGame.TeamColor.WHITE, ChessPiece.PieceType.ROOK));
        board.addPiece(new ChessPosition(2, 1), new ChessPiece(ChessGame.TeamColor.WHITE, ChessPiece.PieceType.PAWN));
        board.addPiece(new ChessPosition(4, 2), new ChessPiece(ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN));
        board.addPiece(new ChessPosition(2, 5), new ChessPiece(ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN));
        Collection<ChessMove> actualMoves1 = board.getPiece(position1).pieceMoves(board, position1);
        Collection<ChessMove> expectedMoves1 = new ArrayList<ChessMove>();
        expectedMoves1.add(new ChessMove(position1, new ChessPosition(3, 2), null));
        expectedMoves1.add(new ChessMove(position1, new ChessPosition(4, 2), null));
        expectedMoves1.add(new ChessMove(position1, new ChessPosition(2, 3), null));
        expectedMoves1.add(new ChessMove(position1, new ChessPosition(2, 4), null));
        expectedMoves1.add(new ChessMove(position1, new ChessPosition(2, 5), null));
        expectedMoves1.add(new ChessMove(position1, new ChessPosition(1, 2), null));
        ...
        ChessPosition position2 = new ChessPosition(1, 1);
        Collection<ChessMove> actualMoves2 = board.getPiece(position2).pieceMoves(board, position2);
        Collection<ChessMove> expectedMoves2 = new ArrayList<ChessMove>();
